...
def classify_image(image_base64_data, file_path=None):
    result = []
    images = get_crop(file_path, image_base64_data)
    for img in images:
...
#function to get input image and then get cropped version of face with eyes detected
def get_crop(image_path, image_base64_data):
...
if __name__ == '__main__':
    ...
    #need to send bit 64 encoded string of image to backend
    print(classify_image(get_b64_test_image_kyrie(), None))
